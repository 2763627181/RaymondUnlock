...
/**
 * Cabecera, pie y accesos flotantes de la tienda. Lo usan el layout de
 * `(marketing)` y el 404 global, que vive fuera de ese grupo y de otro modo
 * saldría sin ningún enlace de navegación.
 */
